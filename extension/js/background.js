...
/** Chrome.windows.WINDOW_ID_CURRENT windowType */
...
/**
 * Ensure that the pinned tabs are pinned in the frontmost window. Returns the
 * action taken.
 *
...
chrome.commands.onCommand.addListener(
  function commandHandler(/** @type {string} */ command) {
    resetAllCaches();
